...
import network.votenet.pointnet2_utils as pointnet2_utils
...
class _PointnetSAModuleBase(nn.Module):
    ...
    def forward(self, xyz: Tensor,
                features: Tensor = None) -> Tuple[Tensor, Tensor]:
        r"""
        Parameters
        ----------
        xyz : Tensor
...
class PointnetSAModuleVotes(nn.Module):
    ...
    def forward(self, xyz: Tensor,
                ...
                inds: Tensor = None) -> Tuple[Tensor, Tensor]:
        r"""
        Parameters
        ----------
        xyz : Tensor
...
class PointnetSAModuleMSGVotes(nn.Module):
    ...
    def forward(self, xyz: Tensor,
                features: Tensor = None, inds: Tensor = None) -> Tuple[Tensor, Tensor]:
        r"""
        Parameters
        ----------
        xyz : Tensor
...
class PointnetFPModule(nn.Module):
    ...
    def forward(
            self, unknown: Tensor, known: Tensor,
            unknow_feats: Tensor, known_feats: Tensor
    ) -> Tensor:
        r"""
        Parameters
        ----------
...
class PointnetLFPModuleMSG(nn.Module):
    ...
    def forward(self, xyz2: Tensor, xyz1: Tensor,
                features2: Tensor, features1: Tensor) -> Tensor:
